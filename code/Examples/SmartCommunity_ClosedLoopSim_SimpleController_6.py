...
simulation_params = {
    "Simulation_Name": "OffGrid_Baseline_WACSC",
...
result_filefolder_paths = {
    "Plot_FileName_Stem": "Gainesville_OffGrid_Baseline_WACSC_",
    "SimulationData_FileName": "SimulationData_Gainesville_OffGrid_Baseline_WACSC",
    "SimulationPerformanceData_FileName": "PerformanceData_Gainesville_OffGrid_Baseline_WACSC",
    "LoadData_FileName": "PecanStreet_LoadData_PVBat_1_Bat_1_PV_1_None_1",
    "WeatherData_FileName": "Gainesville_Irma_OneWeek",
    "Results_FolderPath": r"C:\Users\ninad\Dropbox\NinadGaikwad_PhD\Gaikwad_Research\Gaikwad_Research_Work\25_SmartCommunitySim\code\Examples\Results_OffGrid_Baseline_WACSC"
}
...
###############################################################################################################
## Creating Simple Control Actions
###############################################################################################################

# Create Action
Action_1 = np.ones((1,13,4))

Action_0 = np.zeros((1,13,4))
