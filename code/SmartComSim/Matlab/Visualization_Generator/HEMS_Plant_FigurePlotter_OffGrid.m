function [ ] = HEMS_Plant_FigurePlotter_OffGrid(HEMS_Plant_FigurePlotter_Input)
...
%% Community Local Generation/Local Demand/Grid Power

% Computing Total PV Used
Total_PV_Used = sum(X_k_Plant(:,2,:), 3);

% Computing Total Battery Discharging
Total_Bat_Discharging = sum(X_k_Plant(:,6,:), 3);

% Computing Total Battery Charging
Total_Bat_Charging = sum(X_k_Plant(:,5,:), 3);

% Computing Total Load
Total_Load = sum(X_k_Plant(:,11,:), 3) + sum(X_k_Plant(:,12,:), 3);

% Computing Total Local Generation
Total_Local_Generation_Community = Total_PV_Used + Total_Bat_Discharging;

% Computing Total Local Demand
Total_Local_Demand_Community = Total_Load + Total_Bat_Charging;

% Computing Grid Energy ( + : Community Supplies Grid ; - : Community is served by Grid)
Grid_Energy_Community = 0*Total_Local_Generation_Community;
...
% Compute xticks
X_Ticks_Vector = 0:24:HoursVector(end,1);

% Compute xticklabels
X_Tick_Labels_Cell = {};

for ii=1:length(X_Ticks_Vector)

    X_Tick_Labels_Cell(1,ii) = {num2str(X_Ticks_Vector(ii))};
...
P2 = plot(HoursVector,EToP_Converter*Community_PV_E_Available(1:Len_Hours_Vector,1,1),'--r','LineWidth',2);
...
legend1=legend([P2,P3],'PV Power Available','PV Power Used');
set(legend1,'Interpreter','latex','FontSize', 12);
...
P2 = plot(HoursVector,Community_Bat_SoC(1:Len_Hours_Vector,1,1),'-b','LineWidth',2);
P3 = plot(HoursVector,100*ones(Len_Hours_Vector,1),'--k','LineWidth',1);
P4 = plot(HoursVector,0*ones(Len_Hours_Vector,1),'--k','LineWidth',1);
...
legend1=legend([P2,P5,P6],'SoC','Battery Charging','Battery Discharging');
set(legend1,'Interpreter','latex','FontSize', 12);
...
P2 = plot(HoursVector,Community_Temprature(1:Len_Hours_Vector,1,1),'-b','LineWidth',2);
P3 = plot(HoursVector,T_AC_max*ones(Len_Hours_Vector,1),'--k','LineWidth',1.5);
P4 = plot(HoursVector,T_AC_min*ones(Len_Hours_Vector,1),'--k','LineWidth',1.5);
...
P7 = plot(HoursVector,EToP_Converter*Community_Bat_E_TotalLoad_Actual(1:Len_Hours_Vector,1,1),'-b','LineWidth',2);

P4 = plot(HoursVector,EToP_Converter*Community_Bat_E_TotalLoad_Desired(1:Len_Hours_Vector,1,1),'--r','LineWidth',2);
...
yrule_1(1).FontSize=14;
ylabel('Power $(kW)$','Interpreter','latex','FontSize', 14);
title('Community Level - Total Load Desired vs. Actual');
...
saveas(h24,strcat(Baseline_Output_Images_Path,'Community_Total_Loads'),'jpeg');
...
yrule_1(1).FontSize=14;
ylabel('Power $(kW)$','Interpreter','latex','FontSize', 14);
title('Community Level - AC Startup Power','Interpreter','latex','FontSize', 14);
...
P2 = plot(HoursVector,EToP_Converter*House_PV_E_Available(1:Len_Hours_Vector,1,Single_House_Plotting_Index),'--r','LineWidth',2);
...
yrule_1(1).FontSize=14;
ylabel('Power $(kW)$','Interpreter','latex','FontSize', 14);
title('Single House Level - PV Power','Interpreter','latex','FontSize', 14);
...
yrule_1(1).FontSize=14;
ylabel('$\%$','Interpreter','latex','FontSize', 14);
title('Single House Level - Battery SoC/Charging/Discharging','Interpreter','latex','FontSize', 14);
...
yrule_1(1).FontSize=14;
ylabel('Temperature $(^{\circ}C)$','Interpreter','latex','FontSize', 14);
title('Single House Level - Temperature','Interpreter','latex','FontSize', 14);
...
yrule_1(1).FontSize=14;
ylabel('Power $(kW)$','Interpreter','latex','FontSize', 14);
title('Single House Level - Load Power Desired/Actual','Interpreter','latex','FontSize', 14);
...
yrule_1(1).FontSize=14;
ylabel('Battery Commands','Interpreter','latex','FontSize', 14);
title('Single House Level - Battery Controller Commands','Interpreter','latex','FontSize', 14);
...
P2 = plot(HoursVector,House_AC_Controller_TurnOn_Desired(1:Len_Hours_Vector,1,Single_House_Plotting_Index),'-r','LineWidth',0.2);
P3 = plot(HoursVector,House_AC_Controller_TurnOn_Actual(1:Len_Hours_Vector,1,Single_House_Plotting_Index),'--b','LineWidth',0.2);
...
yrule_1(1).FontSize=14;
ylabel('AC Commands','Interpreter','latex','FontSize', 14);
title('Single House Level - AC Controller Commands','Interpreter','latex','FontSize', 14);
...
%% Community Load Power - Total Local Gen/Local Demand/Grid Power
...
P1 = plot(HoursVector,EToP_Converter*Total_Local_Generation_Community(1:Len_Hours_Vector,1,1),'-b','LineWidth',2);
P4 = plot(HoursVector,EToP_Converter*Grid_Energy_Community(1:Len_Hours_Vector,1,1),'-r','LineWidth',2);
...
yrule_1(1).FontSize=14;
ylabel('Power $(kW)$','Interpreter','latex','FontSize', 14);
title('Community Level - Local Gen/Demand/Grid Power','Interpreter','latex','FontSize', 14);

legend1=legend([P1,P4],'Local Generation', 'Grid Power');
set(legend1,'Interpreter','latex','FontSize', 12);
...
saveas(h23,strcat(Baseline_Output_Images_Path,'Community_LocalGen_GridPower'),'jpeg');
