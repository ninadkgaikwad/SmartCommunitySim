function [U_k] = HEMS_Dumb_LocalController_OffGrid(X_k_Plant,W_k_Plant,HEMSPlant_Params,Community_Params,Simulation_Params)
...
[c_k,d_k] = HEMS_Battery_Controller_OffGrid(Baseline_BatteryController_Input);
