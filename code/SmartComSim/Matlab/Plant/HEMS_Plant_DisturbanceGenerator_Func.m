function W_k_Plant = HEMS_Plant_DisturbanceGenerator_Func(Ws, T_am, GHI, DNI, DateTime_Matrix, E_Load_Desired, E_LoadData, Time_Iter)
    ...
    %   DateTime_Matrix    - Matrix containing date-time information
    ...
    Weather_k_Plant.DateTime_Matrix = DateTime_Matrix(Time_Iter, 1:4);  % First row (Year, Month, Day, Hour)
