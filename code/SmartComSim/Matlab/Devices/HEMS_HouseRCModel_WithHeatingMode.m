function [HEMSHouseRCModel_Output] = HEMS_HouseRCModel_WithHeatingMode(HEMSHouse_Input,HEMSWeatherData_Output,Simulation_Params,HEMSPlant_Params,HEMSHouse_States)
...
u_k_HeatingMode = HEMSHouse_States.u_k_HeatingMode;
...
% Creating appropriately signed u_k_hvac based on u_k_HeatingMode
if (u_k_HeatingMode == 0) % Cooling Mode

    u_k_hvac = u_k_hvac;

elseif (u_k_HeatingMode == 1) % Heating Mode
