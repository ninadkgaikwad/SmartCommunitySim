...
from Exp_RL_Tester_FullRun_Module import *

###############################################################################################################
## Experiment RL Tester - User Inputs
###############################################################################################################
...
csv_name = "Exp_RL_Tester_FullRun_AvgTime_Results.csv"
...
for Community_Type, Grid_Type in product(COMMUNITY_TYPE_LIST, GRID_TYPE_LIST):
    ...
    print(f"\nRunning Exp_RL_Tester_FullRun for Community_Type={Community_Type}, Grid_Type={Grid_Type} ...")

    t0 = time.perf_counter()
    try:
        RL_Tester_Avg_Time = Exp_RL_Tester_FullRun(Community_Type, Grid_Type)
        status = "OK"
        err = ""
    except Exception as e:
        RL_Tester_Avg_Time = np.nan
        status = "ERROR"
        err = repr(e)
    ...
    results.append(
        {
            ...
            "Grid_Type": Grid_Type,
            "RL_Tester_Avg_Time_s": RL_Tester_Avg_Time,      # returned by your function
